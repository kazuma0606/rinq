...
// Error types
pub use shared::error::application_error::{ApplicationError, ApplicationResult};
pub use shared::error::domain_error::{DomainError, DomainResult};
pub use shared::error::infrastructure_error::{InfrastructureError, InfrastructureResult};
pub use shared::error::presentation_error::{PresentationError, PresentationResult};
...
// Application DTOs
pub use application::dto::user_request_dto::{
    CreateUserRequestDto, DeleteUserRequestDto, LoginRequestDto, UpdateUserRequestDto,
};
pub use application::dto::user_response_dto::{LoginResponseDto, UserResponseDto};

// Presentation DTOs
pub use presentation::dto::api_response::ApiResponse;

// Metrics
pub use shared::metrics::collector::MetricsCollector;
